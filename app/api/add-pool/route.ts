...
// The paid business logic for an add-pool (Uniswap V3 liquidity-injection) action.
...
// covered, you may now broadcast the liquidity-injection tx" — and nothing else. This
